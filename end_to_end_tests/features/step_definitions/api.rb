When(/^a heart beat is generated with the following information (.*),(.*),(.*),(.*),(.*)$/) do |centre, male, female, ooc_male, ooc_female|
  @new_post ||=Array.new
  @new_post.push(DC_data::Api_posts.new({:centre => centre, :male_occupied => male.to_i, :female_occupied => female.to_i, :male_ooc => ooc_male.to_i, :female_ooc => ooc_female.to_i}))
